                        ...
                        <div class="row  align-items-center">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="details-tag">
                                    ...
                                    <a href="{{route('page', ['slug' => __('links.blogs'),'utm_code' => csrf_token(),'search'=>$item])}}">{{$item}}</a>
                                    @endforeach
                                </div>
                            </div>
                            @endif
                    ...
                    <div class="rts-single-wized search">
                        ...
                        <div class="wized-body">
                            <div class="rts-search-wrapper">
                                <form class="d-flex" action="{{route('page',['slug' => __('links.blogs')])}}" method="get">
                    ...
                    <div class="rts-single-wized Recent-post">
                        ...
                        <div class="wized-body">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="{{route('blog',['slug'=>$item->getTranslatedAttribute('slug')])}}"><img width="100" src="{{Voyager::image($item->image)}}" alt="{{$item->getTranslatedAttribute('title')}}"></a>
                                </div>
                                <div class="content-area">
                                    ...
                                    <a class="post-title" href="{{route('blog',['slug'=>$item->getTranslatedAttribute('slug')])}}">

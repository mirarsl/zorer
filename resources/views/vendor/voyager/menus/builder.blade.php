            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <input type="link_title" class="form-control" id="m_link_title" name="link_title"
                        ...
                        <select id="m_target" class="form-control" name="target" style="margin-bottom: 1.5em">
                        ...
                        <label for="app_model">Model</label>
                        <input type="app_model" class="form-control" id="m_app_model" name="app_model"
                               placeholder="Model (Altına ilgili model listelenir)"><br>

                        <label for="model_limit">Limit</label>
                        <input type="model_limit" class="form-control" id="model_limit" name="model_limit"
                               placeholder="Kaç tane listelensin? (boş olunca hepsi gelir)"><br>

                        <div id="m_route_type">
                            <label for="model_scopes">Scopeslar</label>
                            <textarea rows="3" class="form-control" id="m_model_scopes" name="model_scopes" placeholder="{{ json_encode(['key' => 'value'], JSON_PRETTY_PRINT) }}"></textarea><br>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var $m_modal       = $('#menu_item_modal'),
                ...
                $m_app_model   = $('#m_app_model'),
                $m_model_limit   = $('#m_model_limit'),
                $m_model_scopes   = $('#m_model_scopes'),
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    $m_link_title.val(_src.data('link_title'));
                    $m_app_model.val(_src.data('app_model'));
                    $m_model_limit.val(_src.data('model_limit'));
                    $m_model_scopes.val(JSON.parse(_src.data('model_scopes')));

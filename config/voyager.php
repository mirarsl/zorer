...
return [
    ...
    */
    ...
    'additional_js' => [
        ...
        '/js/plugins/advlist/plugin.min.js',
        '/js/plugins/autolink/plugin.min.js',
        '/js/plugins/hr/plugin.min.js',
        '/js/plugins/charmap/plugin.min.js',
        '/js/plugins/print/plugin.min.js',
        ...
        '/js/plugins/paste/plugin.min.js',
        '/js/plugins/textpattern/plugin.min.js',
        '/js/plugins/visualblocks/plugin.min.js',
        '/js/plugins/visualchars/plugin.min.js',
        '/js/plugins/fullscreen/plugin.min.js',
        '/js/plugins/insertdatetime/plugin.min.js',
        '/js/plugins/media/plugin.min.js',
        '/js/plugins/nonbreaking/plugin.min.js',
        '/js/plugins/save/plugin.min.js',
        '/js/plugins/directionality/plugin.min.js',
        '/js/plugins/emoticons/plugin.min.js',
        '/js/plugins/template/plugin.min.js',
        '/js/plugins/pagebreak/plugin.min.js',
        '/js/plugins/anchor/plugin.min.js',
        '/js/plugins/wordcount/plugin.min.js',
        '/js/plugins/spellchecker/plugin.min.js',
        '/js/plugins/searchreplace/plugin.min.js',
        '/js/plugins/preview/plugin.min.js',
    ],
